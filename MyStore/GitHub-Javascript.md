...
* [Node](#j-22)
* [Editors](#j-23)
* [Weex&&React Native&&Mobile App&&WebApp&&APP](#j-24)
* [Svg && Canvas && 画布 && 图表 && WebGL](#j-25)
* [构建](#j-26)
* [Animation 动画库](#j-27)
* [Date 组件](#j-28)
* [Socket](#j-29)
...
名称 | 简介 | github
---------|----------|---------
marko| UI库 |  https://github.com/marko-js/marko
ice| ice | https://github.com/alibaba/ice
CMUI | 专攻移动网页的UI框架 | https://github.com/CMUI/CMUI
Semantic-UI | UI组件框架 | https://github.com/Semantic-Org/Semantic-UI
SUI Mobile | 移动端UI库 | https://github.com/sdc-alibaba/SUI-Mobile
mint-ui | Mobile UI elements for vue | https://github.com/ElemeFE/mint-ui
taro | 多端统一开发框架，支持用 React 的开发方式编写一次代码，生成能运行在微信/百度/支付宝/字节跳动小程序、H5、React Native 等的应用。| https://github.com/NervJS/taro
weex-ui | 基于Weex的丰富交互，轻量级，高性能的UI库 | https://github.com/alibaba/weex-ui
vant | Vue构建的轻量级移动UI组件 | https://github.com/youzan/vant
muse-ui | Vuejs 2.0的Material Design UI库 | https://github.com/museui/muse-ui
cube-ui | Vue提供的精彩移动ui | https://github.com/didi/cube-ui
URI.js | URL | https://github.com/medialize/URI.js
iview | 基于Vue.js 2.0构建的高质量UI工具包 | https://github.com/iview/iview
frozenui | CSS组件库 | https://github.com/frozenui/frozenui
weui | WeChat官方设计团队的UI库 | https://github.com/Tencent/weui
element | Vue.js 2.0 UI | https://github.com/ElemeFE/element

## <i id="j-2"></i>UI功能组件

名称 | 简介 | github
---------|----------|---------
pdf.js | pdf查看器大 | https://github.com/mozilla/pdf.js
alertify.js | JavaScript警报/通知系统 | https://github.com/fabien-d/alertify.js
in-view | 当DOM元素进入或退出视口时收到通知 | https://github.com/camwiegert/in-view
cropperjs | JavaScript图像裁剪器 | https://github.com/fengyuanchen/cropperjs
...
throttle-debounce | throttle/debounce速率限制 | https://github.com/niksy/throttle-debounce
pulltorefresh.js |  拉动刷新 | https://github.com/BoxFactura/pulltorefresh.js
fullPage.js | 拉动刷新 | https://github.com/alvarotrigo/fullPage.js
tippyjs | 高度可定制的工具提示和弹出库 | https://github.com/atomiks/tippyjs
clipboard.js | 复制到剪贴板。没有Flash | https://github.com/zenorocha/clipboard.js
...
emitter.js | event-emitter | https://github.com/necolas/emitter.js
dom-helpers | 用于IE8 +的微小，极模块化的DOM辅助库 | https://github.com/react-bootstrap/dom-helpers
resize-detector | 元素调整大小检测 | https://github.com/Justineo/resize-detector
...
名称 | 简介 | github
---------|----------|--------- 
bindingx | Weex/React Native交互解决方案 | https://github.com/alibaba/bindingx
makeitopen | F8应用程序教程 | https://github.com/facebook/makeitopen
f8app | F8应用程序的源代码 | https://github.com/fbsamples/f8app
storybook | 交互式UI组件开发和测试：React，React Native，Vue，Angular | https://github.com/jondot/storybook
deco-ide | React Native IDE | https://github.com/decosoftware/deco-ide
30-days-of-react-native | 30天的React Native演示 | https://github.com/fangwei716/30-days-of-react-native
yoga | Flexbox的跨平台布局引擎 | https://github.com/facebook/yoga
CrossApp | 跨平台移动APP开发引擎 | https://github.com/9miao/CrossApp
NativeScript | NativeScript是一个开源框架 | https://github.com/NativeScript/NativeScript
...
名称 | 简介 | github
---------|----------|--------- 
GCanvas | GCanvas是淘宝开发的移动设备的跨平台渲染引擎 | https://github.com/alibaba/GCanvas
G3D | G3D是一个基于WebGL的javascript 3D引擎 | https://github.com/alibaba/G3D
raphael | JavaScript矢量库（画图）兼容ie6 | https://github.com/DmitryBaranovskiy/raphael
Snap.svg | SVG图形的JavaScript库(不再兼容ie6) | https://github.com/adobe-webplatform/Snap.svg
EaselJS | HTML5中构建高性能交互式2D内容的库。它提供了一个功能丰富的显示列表，允许您操作和动画图形。它还为鼠标和触摸交互提供了强大的交互式模型。 非常适合构建游戏，生成艺术，广告，数据可视化和其他高度图形化的体验。 | https://github.com/CreateJS/EaselJS
fabric.js | 轻松使用HTML5 canvas元素 | https://github.com/fabricjs/fabric.js
cesium | 世界级3D地球仪和地图 | https://github.com/AnalyticalGraphicsInc/cesium
bonsai | BonsaiJS是一个图形库和渲染器 | https://github.com/uxebu/bonsai
f2 | 优雅，互动和灵活的移动图表库 | https://github.com/antvis/f2
engine | 快速轻量级的WebGL游戏引擎 | https://github.com/playcanvas/engine
melonJS | 轻量级的JavaScript游戏引擎 | https://github.com/melonjs/melonJS
html2canvas | web屏幕截图 | https://github.com/niklasvh/html2canvas
Chart.js | HTML5图表 | https://github.com/chartjs/Chart.js
paper.js | HTML5 Canvas | https://github.com/paperjs/paper.js
...
名称 | 简介 | github
---------|----------|--------- 
rax | 构建通用应用程序 | https://github.com/alibaba/rax
cooking | 前端构建工具 | https://github.com/ElemeFE/cooking
...
名称 | 简介 | github
---------|----------|--------- 
electron-vue | Electron＆Vue.js快速启动样板 | https://github.com/SimulatedGREG/electron-vue
nativescript-vue | nativescript | https://github.com/nativescript-vue/nativescript-vue
